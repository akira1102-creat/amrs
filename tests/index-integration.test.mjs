...
test("Galaxy Log stays in its own page and cached assets", () => {
  ...
  assert.match(html, /xlsx\.mini\.min\.js\?v=20260901s/);
  assert.match(html, /galaxy-log\.js\?v=20260901s/);
  assert.match(html, /galaxy-log\.css\?v=20260901s/);
  assert.match(worker, /xlsx\.mini\.min\.js\?v=20260901s/);
  assert.match(worker, /galaxy-log\.js\?v=20260901s/);
  assert.match(worker, /galaxy-log\.css\?v=20260901s/);
