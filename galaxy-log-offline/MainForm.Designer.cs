...
public partial class MainForm
{
    ...
    private void InitializeComponent()
    {
        ...
        taskList.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right; taskList.AutoScroll = true; taskList.FlowDirection = FlowDirection.LeftToRight; taskList.WrapContents = true; taskList.Location = new Point(31, 291); taskList.Size = new Size(389, 420); taskList.Padding = new Padding(0, 4, 10, 20);
        statusLabel.Anchor = AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right; statusLabel.AutoEllipsis = true; statusLabel.ForeColor = Color.FromArgb(139, 148, 158); statusLabel.Location = new Point(31, 730); statusLabel.Size = new Size(389, 38); statusLabel.Text = "準備就緒";
        AutoScaleDimensions = new SizeF(7F, 15F); AutoScaleMode = AutoScaleMode.Font; BackColor = Color.FromArgb(13, 17, 23); ClientSize = new Size(455, 785); Controls.AddRange(new Control[] { titleLabel, subtitleLabel, importButton, exportButton, searchBox, statusFilter, summaryLabel, taskList, statusLabel }); ForeColor = Color.FromArgb(230, 237, 243); MinimumSize = new Size(455, 600); StartPosition = FormStartPosition.CenterScreen; Text = "Galaxy 取 Log Offline";
